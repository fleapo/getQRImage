...
from getQRImage.mylibs import data, ECC, structure, matrix, draw

# ver: Version from 1 to 40
# ecl: Error Correction Level (L,M,Q,H)
# get a qrcode picture of 3*3 pixels per module
def get_qrcode(ver, ecl, str, save_place, content_only):
    # Data Coding
    ...
    return ver, draw.draw_qrcode(save_place, qrmatrix, content_only)
